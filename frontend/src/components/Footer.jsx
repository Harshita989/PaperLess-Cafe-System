    ...
    <footer className="w-full bg-gradient-to-r from-amber-600 to-amber-800 text-white py-8 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <h3 className="text-xl font-bold font-display">HotShots Cafe</h3>
          ...
          <p className="text-amber-200 mt-4 md:mt-0"> {new Date().getFullYear()} HotShots. All rights reserved</p>
        </div>
      </div>
    </footer>
  );
